        ...
        <div class="row ">
          ...
          <div class="col-8 main-width">
            <div class="over-wrap">
              ...
              <form method="POST" action="/bul/bulfreeaddok.do">
                ...
                <div class="form-floating">
                    <textarea name="content" class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 400px;"></textarea>
                </div>
